...
const char* SSID = "radha"; // SSID / nome da rede WI-FI que deseja se conectar
...
void initOTA()
{
  ...
  ArduinoOTA.setHostname("RadhaEsp"); // Define o nome da porta

  // No authentication by default
   ArduinoOTA.setPassword((const char *)"12345678"); // senha para carga via WiFi (OTA)
  ArduinoOTA.onStart([]() {
